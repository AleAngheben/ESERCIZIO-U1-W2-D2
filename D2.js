...
/* SCRIVI QUI LA TUA RISPOSTA */
let totalShoppingCart = 47.5;
if (totalShoppingCart >= 50) {
  console.log("Ammontare totale dell'ordine:", totalShoppingCart + "€");
} else {
  console.log("Ammontare totale dell'ordine:", totalShoppingCart + 10 + "€");
}
...
/* SCRIVI QUI LA TUA RISPOSTA */
let discount = 0.2 * totalShoppingCart;
if (totalShoppingCart >= 50) {
  console.log(
